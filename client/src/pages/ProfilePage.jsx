      ...
      className="flex flex-col gap-5 p-10 flex-1"> 
        ...
        cursor-pointer'>
          ...
          id='avatar' accept='.png,.jpg,.jpeg' hidden/>
            <img src={selectedImage ? URL.createObjectURL(selectedImage) : assets.
              avatar_icon} alt="" className={`w-12 h-12 ${selectedImage && 'rounded-full'}`}/>
       ...
       mx-10 max-sm:mt-10 ${selectedImage && 'rounded-full'}`}
